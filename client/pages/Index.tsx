    ...
    <div className="min-h-screen bg-black relative overflow-hidden">
      ...
      <section className="relative z-10 px-6 lg:px-12 py-16 lg:py-24 min-h-screen flex items-center">
        <div className="max-w-6xl mx-auto w-full">
          ...
          {/* Expertise Highlights - 2x2 Grid with Dramatic Reveals */}
          <div className="relative pt-8 pb-6 max-w-6xl mx-auto">
            {/* Top Row - Wide Spacing (Pyramid Top) */}
            <div className="flex flex-col lg:flex-row gap-8 lg:gap-24 justify-center items-center mb-8">
              <div className="w-64 group">
                <div className="relative bg-gradient-to-r from-cyan-500/5 to-cyan-500/10 rounded-xl p-5 border-l-4 border-cyan-400/70 transform transition-all duration-1000 ease-out opacity-0 translate-x-[-50px] animate-[slideInDramatic_1.2s_ease-out_0.3s_forwards]">
                  <div className="flex items-start space-x-4">
                    <div className="w-8 h-8 bg-gradient-to-r from-cyan-400 to-cyan-500 rounded-full flex items-center justify-center flex-shrink-0 shadow-lg shadow-cyan-400/25">
                      <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
                      </svg>
                    </div>
                    <div>
                      <h3 className="text-base font-bold text-white mb-2">Intelligent Agentic Systems</h3>
              ...
              <div className="w-64 group">
                <div className="relative bg-gradient-to-r from-purple-500/5 to-purple-500/10 rounded-xl p-5 border-l-4 border-purple-400/70 transform transition-all duration-1000 ease-out opacity-0 translate-x-[50px] animate-[slideInDramatic_1.2s_ease-out_0.6s_forwards]">
                  <div className="flex items-start space-x-4">
                    <div className="w-8 h-8 bg-gradient-to-r from-purple-400 to-purple-500 rounded-full flex items-center justify-center flex-shrink-0 shadow-lg shadow-purple-400/25">
                      <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                      </svg>
                    </div>
                    <div>
                      <h3 className="text-base font-bold text-white mb-2">Search & Retrieval</h3>
            ...
            <div className="flex flex-col lg:flex-row gap-8 lg:gap-16 justify-center items-center">
              <div className="w-64 group">
                <div className="relative bg-gradient-to-r from-emerald-500/5 to-emerald-500/10 rounded-xl p-5 border-l-4 border-emerald-400/70 transform transition-all duration-1000 ease-out opacity-0 translate-x-[-50px] animate-[slideInDramatic_1.2s_ease-out_0.9s_forwards]">
                  <div className="flex items-start space-x-4">
                    <div className="w-8 h-8 bg-gradient-to-r from-emerald-400 to-emerald-500 rounded-full flex items-center justify-center flex-shrink-0 shadow-lg shadow-emerald-400/25">
                      <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />
                      </svg>
                    </div>
                    <div>
                      <h3 className="text-base font-bold text-white mb-2">Recommendations</h3>
              ...
              <div className="w-64 group">
                <div className="relative bg-gradient-to-r from-pink-500/5 to-pink-500/10 rounded-xl p-5 border-l-4 border-pink-400/70 transform transition-all duration-1000 ease-out opacity-0 translate-x-[50px] animate-[slideInDramatic_1.2s_ease-out_1.2s_forwards]">
                  <div className="flex items-start space-x-4">
                    <div className="w-8 h-8 bg-gradient-to-r from-pink-400 to-pink-500 rounded-full flex items-center justify-center flex-shrink-0 shadow-lg shadow-pink-400/25">
                      <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 9l3 3-3 3m5 0h3M5 20h14a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                      </svg>
                    </div>
                    <div>
                      <h3 className="text-base font-bold text-white mb-2">Context Engineering & Deployment</h3>
          ...
          <style jsx>{`
            @keyframes slideInDramatic {
              from {
                opacity: 0;
                transform: translateX(var(--tw-translate-x)) translateY(20px) scale(0.95);
              }
              to {
                opacity: 1;
