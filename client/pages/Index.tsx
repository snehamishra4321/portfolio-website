            ...
            <div className="grid lg:grid-cols-2 gap-6">
              ...
              <div className="bg-gradient-to-br from-cyan-500/10 to-cyan-500/5 backdrop-blur-sm rounded-2xl p-8 border border-cyan-400/20">
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-white/80 leading-relaxed">
                    Leading <span className="text-cyan-400 font-semibold">product development</span> and built reliable evaluation systems for chat across various scenarios with strong guardrails for production use cases.
                  </p>
