    ...
    <div className="min-h-screen bg-black relative overflow-hidden">
      ...
      <section className="relative z-10 px-6 lg:px-12 py-16 lg:py-24 min-h-screen flex items-center">
        <div className="max-w-6xl mx-auto w-full">
          ...
          {/* Expertise Highlights - Fancy Staggered Layout */}
          <div className="relative pt-16 pb-8 max-w-5xl mx-auto">
            {/* Top Row - Offset Left */}
            <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 mb-12">
              <div className="lg:w-1/2 lg:ml-0">
                <div className="flex items-start space-x-4 bg-gradient-to-r from-cyan-500/5 to-cyan-500/10 rounded-xl p-6 border-l-4 border-cyan-400">
                  <div className="w-10 h-10 bg-gradient-to-r from-cyan-400 to-cyan-500 rounded-full flex items-center justify-center flex-shrink-0">
                    <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
                    </svg>
                  </div>
                  <div>
                    <h3 className="text-lg font-semibold text-white mb-2">Intelligent Agentic Systems</h3>
                    <p className="text-white/70 text-sm">Designing AI that adapts and scales</p>
                  </div>
                </div>
              </div>

              <div className="lg:w-1/2 lg:ml-auto lg:mt-8">
                <div className="flex items-start space-x-4 bg-gradient-to-r from-purple-500/5 to-purple-500/10 rounded-xl p-6 border-l-4 border-purple-400">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-white mb-2">Search & Retrieval</h3>
                    <p className="text-white/70 text-sm">RAG pipelines for relevance and impact</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
              <div className="lg:w-1/2 lg:ml-auto lg:-mt-4">
                <div className="flex items-start space-x-4 bg-gradient-to-r from-emerald-500/5 to-emerald-500/10 rounded-xl p-6 border-l-4 border-emerald-400">
                  <div className="w-10 h-10 bg-gradient-to-r from-emerald-400 to-emerald-500 rounded-full flex items-center justify-center flex-shrink-0">
                    <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div>
                    ...
                    <p className="text-white/70 text-sm">User-facing intelligence through RecSys</p>
                  </div>
                </div>
              </div>

              <div className="lg:w-1/2 lg:ml-0 lg:mt-4">
                <div className="flex items-start space-x-4 bg-gradient-to-r from-pink-500/5 to-pink-500/10 rounded-xl p-6 border-l-4 border-pink-400">
                  <div className="w-10 h-10 bg-gradient-to-r from-pink-400 to-pink-500 rounded-full flex items-center justify-center flex-shrink-0">
                    <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 19l9 2-9-18-9 18 9-2zm0 0v-8" />
                    </svg>
                  </div>
                  <div>
                    <h3 className="text-lg font-semibold text-white mb-2">Shipping AI Solutions</h3>
                    <p className="text-white/70 text-sm">From research to production platforms</p>
                  </div>
                </div>
              </div>
            </div>
