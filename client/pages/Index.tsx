    ...
    <div className="min-h-screen bg-black relative overflow-hidden">
      ...
      <section className="relative z-10 px-6 lg:px-12 py-16 lg:py-24 min-h-screen flex items-center">
        <div className="max-w-6xl mx-auto w-full">
          ...
          {/* Expertise Highlights - Elegant Sliding Layout */}
          <div className="relative pt-16 pb-8 max-w-5xl mx-auto">
            {/* Top Row - Offset Left */}
            <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 mb-12">
              <div className="lg:w-1/2 lg:ml-0 group">
                <div className="relative pl-6 py-4 transform transition-transform duration-700 ease-out hover:translate-x-2">
                  <div className="absolute left-0 top-0 bottom-0 w-0.5 bg-gradient-to-b from-cyan-400/50 to-cyan-400 group-hover:shadow-cyan-400/50 group-hover:shadow-sm transition-all duration-500"></div>
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="opacity-0 animate-[slideIn_0.8s_ease-out_0.2s_forwards]">
                      <h3 className="text-lg font-medium text-white mb-1">Intelligent Agentic Systems</h3>
                      <p className="text-white/60 text-sm">Designing AI that adapts and scales</p>
                    </div>
                  </div>
                </div>
              </div>

              <div className="lg:w-1/2 lg:ml-auto lg:mt-8 group">
                <div className="relative pl-6 py-4 transform transition-transform duration-700 ease-out hover:translate-x-2">
                  <div className="absolute left-0 top-0 bottom-0 w-0.5 bg-gradient-to-b from-purple-400/50 to-purple-400 group-hover:shadow-purple-400/50 group-hover:shadow-sm transition-all duration-500"></div>
                  <div className="flex items-start space-x-4">
                    <div className="w-8 h-8 bg-gradient-to-r from-purple-400 to-purple-500 rounded-full flex items-center justify-center flex-shrink-0 opacity-90">
                      <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                      </svg>
                    </div>
                    <div className="opacity-0 animate-[slideIn_0.8s_ease-out_0.4s_forwards]">
                      <h3 className="text-lg font-medium text-white mb-1">Search & Retrieval</h3>
                      <p className="text-white/60 text-sm">RAG pipelines for relevance and impact</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
              <div className="lg:w-1/2 lg:ml-auto lg:-mt-4 group">
                <div className="relative pl-6 py-4 transform transition-transform duration-700 ease-out hover:translate-x-2">
                  <div className="absolute left-0 top-0 bottom-0 w-0.5 bg-gradient-to-b from-emerald-400/50 to-emerald-400 group-hover:shadow-emerald-400/50 group-hover:shadow-sm transition-all duration-500"></div>
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="opacity-0 animate-[slideIn_0.8s_ease-out_0.6s_forwards]">
                      <h3 className="text-lg font-medium text-white mb-1">Recommendations</h3>
                      <p className="text-white/60 text-sm">User-facing intelligence through RecSys</p>
                    </div>
                  </div>
                </div>
              </div>

              <div className="lg:w-1/2 lg:ml-0 lg:mt-4 group">
                <div className="relative pl-6 py-4 transform transition-transform duration-700 ease-out hover:translate-x-2">
                  <div className="absolute left-0 top-0 bottom-0 w-0.5 bg-gradient-to-b from-pink-400/50 to-pink-400 group-hover:shadow-pink-400/50 group-hover:shadow-sm transition-all duration-500"></div>
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="opacity-0 animate-[slideIn_0.8s_ease-out_0.8s_forwards]">
                      <h3 className="text-lg font-medium text-white mb-1">Shipping AI Solutions</h3>
                      <p className="text-white/60 text-sm">From research to production platforms</p>
                    </div>
                  </div>
                </div>
              </div>
