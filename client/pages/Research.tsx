    ...
    <div className="min-h-screen bg-black relative overflow-hidden">
      ...
      <header className="relative z-10 flex items-center justify-between p-6 lg:px-12">
        ...
        <nav className="flex items-center space-x-8">
          ...
          <Link to="/research" className="text-white hover:text-cyan-400 transition-all duration-300 border-b border-cyan-400">
            Research
          </Link>
      ...
      <section className="relative z-10 px-6 lg:px-12 py-16">
        <div className="max-w-6xl mx-auto">
          <h1 className="text-5xl lg:text-6xl font-bold text-white mb-8">
            Research & <span className="bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent">Publications</span>
          </h1>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10">
              ...
              <p className="text-cyan-400 font-semibold mb-4">NPJ Precision Oncology by Nature</p>
              <p className="text-white/70 text-lg leading-relaxed mb-6">
                Implemented multi-class classification on Lamin B1 stained imaging for breast cancer tissues, 
                augmenting datasets and fine-tuning AI models (ViT, ResNet50, InceptionV3) to investigate 
                extreme nuclear wrinkling as a cancer biomarker.
              </p>
              <div className="flex flex-wrap gap-3">
                <span className="bg-purple-500/20 text-purple-300 px-3 py-1 rounded-full text-sm">Computer Vision</span>
                <span className="bg-cyan-500/20 text-cyan-300 px-3 py-1 rounded-full text-sm">Deep Learning</span>
                <span className="bg-emerald-500/20 text-emerald-300 px-3 py-1 rounded-full text-sm">Medical AI</span>
                <span className="bg-pink-500/20 text-pink-300 px-3 py-1 rounded-full text-sm">Vision Transformers</span>
              </div>
            </div>
            ...
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10">
              ...
              <p className="text-white/70 text-lg leading-relaxed mb-6">
                Developed LLM-Pruner, a task-agnostic compression tool for LLaMA-7B, achieving a 30% size 
                reduction while maintaining baseline performance. Focus on efficient model deployment 
                for resource-constrained environments.
              </p>
              <div className="flex flex-wrap gap-3">
                <span className="bg-purple-500/20 text-purple-300 px-3 py-1 rounded-full text-sm">Model Compression</span>
                <span className="bg-cyan-500/20 text-cyan-300 px-3 py-1 rounded-full text-sm">LLMs</span>
                <span className="bg-emerald-500/20 text-emerald-300 px-3 py-1 rounded-full text-sm">Optimization</span>
              </div>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8 mt-12">
              ...
              <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10">
                <h3 className="text-xl font-bold text-white mb-4">Research Collaborations</h3>
