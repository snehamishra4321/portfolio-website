      ...
      <section className="relative z-10 px-6 lg:px-12 py-16">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-white/70 mb-12 leading-relaxed">
            ...
            potential collaborations. Whether you're interested in my work or
            have an exciting opportunity, I'd love to hear from you.
          </p>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gradient-to-r from-cyan-500/10 to-purple-500/10 backdrop-blur-sm rounded-xl p-8 border border-cyan-500/20">
                ...
                <p className="text-white/70 leading-relaxed">
                  ...
                  systems, computer vision applications in healthcare, and
                  scalable AI infrastructure. If you have an exciting challenge
                  or opportunity, let's discuss how we can work together!
                </p>
              </div>
            </div>
          </div>
